# TON MCP Documentation

Welcome to the complete documentation for TON MCP - the most comprehensive Model Context Protocol server for TON blockchain development.
...
How to use TON MCP with different AI tools:

- **[cursor.md](integration_guides/cursor.md)** - Using with Cursor IDE
- **[claude_code.md](integration_guides/claude_code.md)** - Using with Claude Code
- **[user_guide.md](integration_guides/user_guide.md)** - General user guide
- **[development_usage.md](integration_guides/development_usage.md)** - Development usage
...
### Complete Workflows
- Beginner: Simple contracts
- Intermediate: Tokens, NFTs, TMAs
- Advanced: DeFi, DAOs, Full-stack dApps
...
**I want to use TON MCP:**
1. [COMPLETE_FEATURE_SUMMARY.md](general/COMPLETE_FEATURE_SUMMARY.md) - What you can do
2. [integration_guides/cursor.md](integration_guides/cursor.md) - Setup in Cursor
3. [integration_guides/user_guide.md](integration_guides/user_guide.md) - How to use
...
1. **Install & Setup**
   - Read: [INTEGRATION_QUICKSTART.md](general/INTEGRATION_QUICKSTART.md)
   - Setup: [cursor.md](integration_guides/cursor.md)

2. **First Steps**
   - Explore: [user_guide.md](integration_guides/user_guide.md)
   - Try: "Search TON docs for smart contracts"

3. **Create First Project**
   - Try: "Create a simple counter contract"
   - Follow: AI guidance to use Blueprint
...
2. **Understand Architecture**
   ...
   - Study: Official tools integration
...
**"How do I install?"**
→ [INTEGRATION_QUICKSTART.md](general/INTEGRATION_QUICKSTART.md)

**"What can this MCP do?"**
→ [COMPLETE_FEATURE_SUMMARY.md](general/COMPLETE_FEATURE_SUMMARY.md)

**"How does it work?"**
→ [IMPROVED_ARCHITECTURE.md](general/IMPROVED_ARCHITECTURE.md)
...
2. **Documentation unclear?**
   ...
   - Suggest improvement: Pull request welcome

3. **Want to contribute?**
   - Read: [development_usage.md](integration_guides/development_usage.md)
   - Fork: Repository
   - Submit: Pull request
...
# 2. Configure Cursor (or your AI tool)
...
# 3. Start using!
# In Cursor, try: "Search TON docs for smart contracts"
```
...
```
"What can TON MCP do?"
"Create a simple smart contract project"
"Search TON documentation for Jettons"
"Generate a token contract in Tolk"
...
**Complete**: From installation to mastery

---

## 🚀 Start Your TON Development Journey!

Choose your path:

1. **New to TON?**
   → Start with [COMPLETE_FEATURE_SUMMARY.md](general/COMPLETE_FEATURE_SUMMARY.md)

2. **Ready to build?**
   → Follow [INTEGRATION_QUICKSTART.md](general/INTEGRATION_QUICKSTART.md)
